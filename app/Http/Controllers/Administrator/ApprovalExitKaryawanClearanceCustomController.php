...
class ApprovalExitKaryawanClearanceCustomController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view('administrator.approval-clearance-custom.index')->with($params);
    }
    ...
    public function detail($id)
    {
        ...
        return view('administrator.approval-clearance-custom.detail')->with($params);
    }
    ...
    {  
       if($request->asset != null)
        ...
        return redirect()->route('administrator.approval.clearance-custom.index')->with('message-success', 'Exit Clearance succesfully process')->with($params);
    }
}
