...
class ApprovalLeaveCustomController extends Controller
{
    ...
    public function index()
    {
      //
        ...
        return view('administrator.approval-leave-custom.index')->with($params);
    }
    ...
    {   
        ...
        return view('administrator.approval-leave-custom.detail')->with($params);
    }
    ...
    public function proses(Request $request)
    {
        ...
        //$params['datas'] = cek_leave_approval();
         return redirect()->route('administrator.approval.leave-custom.index')->with('messages-success', 'Leave Form Successfully processed !');
    }
}
