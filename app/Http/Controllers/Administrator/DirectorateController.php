...
class DirectorateController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('administrator.directorate.index')->with('message-success', 'Data berhasi di hapus');
    } 
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('administrator.directorate.index')->with('message-success', 'Data saved successfully !');
    }
}
