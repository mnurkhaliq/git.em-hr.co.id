...
class EmporeManagerController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('administrator.empore-manager.index')->with('message-success', 'Data saved successfully');
    }   
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('administrator.empore-manager.index')->with('message-success', 'Data berhasi di hapus');
    } 
