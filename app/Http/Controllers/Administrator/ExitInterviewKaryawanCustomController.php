...
class ExitInterviewKaryawanCustomController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('administrator.exit-interview-custom.index')->with($params);
    }
    ...
    {
        //
        return view('administrator.exit-interview-custom.create');
    }
    ...
    {
        //
        $checkApproval = \Auth::user()->approval->level1Exit;
        ...
        $settingApprovalItem = \Auth::user()->approval->level1Exit->structure_organization_custom_id;

            $historyApproval    = \Auth::user()->approval->itemsExit;
            ...
            return redirect()->route('administrator.exit-custom.index')->with('message-success', 'Exit Interview succesfully process');
    ...
    public function edit($id)
    {
        ...
        return view('administrator.exit-interview-custom.detail')->with($params);
    }
    ...
    public function prosesclearance(Request $request)
    {
        ...
        return redirect()->route('administrator.exit-custom.index')->with('message-success', 'Exit Clearance succesfully process');
    }
}
