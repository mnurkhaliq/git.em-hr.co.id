...
class OvertimeKaryawanCustomController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('administrator.overtime-custom.index')->with($params);
    }
    ...
    public function create()
    {
        ...
        return view('administrator.overtime-custom.create')->with($params);
    }
    ...
    {
        //
        $checkApproval = \Auth::user()->approval->level1Overtime;
        if($checkApproval == null)
        {
            return redirect()->route('administrator.overtime-custom.index')->with('message-error', 'Setting approval not define yet. Please contact your admin !');
        }else{
            ...
            $settingApprovalItem = \Auth::user()->approval->level1Overtime->structure_organization_custom_id;

            $historyApproval    = \Auth::user()->approval->itemsOvertime;
            ...
            return redirect()->route('administrator.overtime-custom.index')->with('message-success', 'Data successfully saved!');
        }
    ...
    public function edit($id)
    {
        ...
        return view('administrator.overtime-custom.edit')->with($params);
    }
    ...
    public function claim($id)
    {
       ...
       // dd($over);
        ...
        return view('administrator.overtime-custom.claim')->with($params);
    }
