...
{   
    ...
    public function index()
    {
        ...
        if($user->project_id != NULL)
        {
            ...
            $params['data_type']        = TrainingType::join('users','users.id','=','training_type.user_created')->where('users.project_id', $user->project_id)->select('training_type.*')->get();
        }else{
            $params['data']             = PlafondDinas::orderby('organisasi_position_id','DESC')->get();
            $params['data_luarnegeri']  = PlafondDinasLuarNegeri::all();
            $params['data_type']        = TrainingType::all();
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->tunjangan_makanan            = preg_replace('/[^0-9]/', '',$request->tunjangan_makanan);
        $data->tunjangan_harian             = preg_replace('/[^0-9]/', '',$request->tunjangan_harian);
    ...
    public function settlementDuration(Request $request) {
        $user = \Auth::user();
