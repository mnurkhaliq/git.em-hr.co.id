...
class SettingApprovalLeaveController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('administrator.setting-approvalLeave.index')->with('message-success', 'Data successfully deleted');
    }
    ...
    public function indexItem($id)
    {
        //
        $params['data'] = SettingApproval::where('id', $id)->first();
        $params['dataItem'] = SettingApprovalLeaveItem::where('setting_approval_id', $id)->orderBy('setting_approval_level_id')->get();
        if(!$params['data']){
            return redirect()->route('administrator.setting-approvalLeave.index')->with('message-error', 'Data not found!');
        }
...
//            return redirect()->route('administrator.setting-approvalLeave.indexItem', $request->setting_approval_id)->with('message-error', 'Approval position is incomplete!');
        }
...
//            return redirect()->route('administrator.setting-approvalLeave.indexItem', $request->setting_approval_id)->with('message-error', 'Approval position is incomplete!');
        ...
        {
            $checkdata         = SettingApprovalLeaveItem::where('setting_approval_id', $request->setting_approval_id)->where('setting_approval_level_id', $request->setting_approval_level_id)->first();
            $checkDataStruktur = SettingApprovalLeaveItem::where('setting_approval_id', $request->setting_approval_id)->where('structure_organization_custom_id', $request->structure_organization_custom_id)->first();
            ...
            }else
            {
                ...
                $data->description = $request->description;
                $data->save();
                return redirect()->route('administrator.setting-approvalLeave.indexItem', $request->setting_approval_id)->with('message-success', 'Data successfully saved!');
            }
        }
    }
    ...
    public function updateItem(Request $request, $id)
    {
        ...
        $checkdata = SettingApprovalLeaveItem::where('setting_approval_id', $request->setting_approval_id)->where('setting_approval_level_id', $request->setting_approval_level_id)->where('id','!=',$id)->first();
        $checkDataStruktur = SettingApprovalLeaveItem::where('setting_approval_id', $request->setting_approval_id)->where('structure_organization_custom_id', $request->structure_organization_custom_id)->where('id','!=',$id)->first();
        
        /*if($request->setting_approval_level_id == NULL)
        {
            return redirect()->route('administrator.setting-approvalLeave.indexItem', $request->setting_approval_id)->with('message-error', 'Approval level is incomplete!');
        }else
        */
        ...
        if ($request->structure_organization_custom_id == NULL) {
            ...
            }else
            {
                ...
                return redirect()->route('administrator.setting-approvalLeave.indexItem', $data->setting_approval_id)->with('message-success', 'Data successfully saved');
            }
        }
    ...
    public function destroyItem($id)
    {
        ...
        return redirect()->route('administrator.setting-approvalLeave.indexItem',$id)->with('message-success', 'Data successfully deleted');
    }
}
