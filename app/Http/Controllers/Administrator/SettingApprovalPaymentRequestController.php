...
class SettingApprovalPaymentRequestController extends Controller
{
    ...
    public function indexItem($id)
    {
        ...
        $params['dataItem'] = SettingApprovalPaymentRequestItem::where('setting_approval_id', $id)->orderBy('setting_approval_level_id')->get();
        if(!$params['data']){
            return redirect()->route('administrator.setting-approvalPaymentRequest.index')->with('message-error', 'Data not found!');
        }
    ...
    public function storeItem(Request $request)
    {
        ...
        $checkdata = SettingApprovalPaymentRequestItem::where('setting_approval_id', $request->setting_approval_id)->where('setting_approval_level_id', $request->setting_approval_level_id)->first();
        $checkDataStruktur = SettingApprovalPaymentRequestItem::where('setting_approval_id', $request->setting_approval_id)->where('structure_organization_custom_id', $request->structure_organization_custom_id)->first();
        //
        if ($request->structure_organization_custom_id == NULL) {
            ...
            }else
            {
                ...
                return redirect()->route('administrator.setting-approvalPaymentRequest.indexItem', $request->setting_approval_id)->with('message-success', 'Data successfully saved!');
            }
        }
    ...
    public function updateItem(Request $request, $id)
    {
        ...
        $checkdata = SettingApprovalPaymentRequestItem::where('setting_approval_id', $request->setting_approval_id)->where('setting_approval_level_id', $request->setting_approval_level_id)->where('id','!=',$id)->first();
        $checkDataStruktur = SettingApprovalPaymentRequestItem::where('setting_approval_id', $request->setting_approval_id)->where('structure_organization_custom_id', $request->structure_organization_custom_id)->where('id','!=',$id)->first();
        ...
        }else
        {
            ...
            }else
            {
                ...
                return redirect()->route('administrator.setting-approvalPaymentRequest.indexItem', $data->setting_approval_id)->with('message-success', 'Data successfully saved');
            }
        }
    ...
    public function destroyItem($id)
    {
        ...
        return redirect()->route('administrator.setting-approvalPaymentRequest.indexItem',$id)->with('message-success', 'Data successfully deleted');
    }
