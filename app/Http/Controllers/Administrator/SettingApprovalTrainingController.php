...
class SettingApprovalTrainingController extends Controller
{
    ...
    public function indexItem($id)
    {
        ...
        $params['dataItem'] = SettingApprovalTrainingItem::where('setting_approval_id', $id)->orderBy('setting_approval_level_id')->get();
        if(!$params['data']){
            return redirect()->route('administrator.setting-approvalTraining.index')->with('message-error', 'Data not found!');
        }
    ...
    public function storeItem(Request $request)
    {
        ...
        $checkdata = SettingApprovalTrainingItem::where('setting_approval_id', $request->setting_approval_id)->where('setting_approval_level_id', $request->setting_approval_level_id)->first();
        $checkDataStruktur = SettingApprovalTrainingItem::where('setting_approval_id', $request->setting_approval_id)->where('structure_organization_custom_id', $request->structure_organization_custom_id)->first();
        //
        if($request->setting_approval_level_id == NULL)
        {
            ...
            }else
            {
                ...
                return redirect()->route('administrator.setting-approvalTraining.indexItem', $request->setting_approval_id)->with('message-success', 'Data successfully saved!');
            }
        }
    ...
    public function updateItem(Request $request, $id)
    {
        ...
        $checkdata = SettingApprovalTrainingItem::where('setting_approval_id', $request->setting_approval_id)->where('setting_approval_level_id', $request->setting_approval_level_id)->where('id','!=',$id)->first();
        $checkDataStruktur = SettingApprovalTrainingItem::where('setting_approval_id', $request->setting_approval_id)->where('structure_organization_custom_id', $request->structure_organization_custom_id)->where('id','!=',$id)->first();
        if($checkdata){
            return redirect()
                ->back()
                ->withInput()
        ...
        }else
        {
            ...
            else
            {
                ...
                return redirect()->route('administrator.setting-approvalTraining.indexItem', $data->setting_approval_id)->with('message-success', 'Data successfully saved');
            }
        }
    ...
    public function destroyItem($id)
    {
        ...
        return redirect()->route('administrator.setting-approvalTraining.indexItem',$id)->with('message-success', 'Data successfully deleted');
    }
}
