...
class CutiController extends Controller 
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('karyawan.cuti.index')->with('message-success', 'Data successfully deleted');
    }
    ...
    public function store(Request $request)
    {
        ...
        $permitleave = Cuti::where('id',$request->jenis_cuti)->first();
        $data->temp_kuota               = $request->temp_kuota;
        if ($permitleave->jenis_cuti=='Permit')
        {
            $data->temp_cuti_terpakai       = null;
            $data->temp_sisa_cuti           =null;
        }
        else
        {
