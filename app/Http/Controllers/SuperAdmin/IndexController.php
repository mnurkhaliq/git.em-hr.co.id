...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        if($user->project_id != NULL) {
            ...
            $params['product'] = CrmOdooModule::all();
            $params['project'] = ConfigDB::where('id', $user->project_id)->get();
        }
    ...
    public function updateModul(Request $request)
    {
        ...
        if($request->project_product_id != null) {
            ...
            $url = env('URL_API','https://testapi.em-hr.co.id/').'update-modul-crm';
        ...
        return redirect()->route('superadmin.dashboard')->with('message-success', 'Data successfully saved');
    }
