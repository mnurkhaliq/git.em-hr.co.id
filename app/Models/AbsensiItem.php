...
class AbsensiItem extends Model
{
    ...
    /**
    * [cabangIn description]
    * @return [type] [description]
    */
    public function cabangIn()
    {
        return $this->hasOne('App\Models\Cabang', 'id', 'cabang_id_in');
    }
    /**
     * [cabangOut description]
     * @return [type] [description]
     */
    public function cabangOut()
    {
        return $this->hasOne('App\Models\Cabang', 'id', 'cabang_id_out');
    }
