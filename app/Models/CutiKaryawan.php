...
class CutiKaryawan extends Model
{
    ...
    {
        return $this->hasOne('App\Models\Cuti', 'id', 'jenis_cuti')->withTrashed();
    }
    ...
    {
        return $this->hasMany('\App\Models\HistoryApprovalLeave', 'cuti_karyawan_id', 'id')->orderBy('is_withdrawal', 'ASC')->orderBy('setting_approval_level_id', 'ASC');
    }

    public function cutiKaryawanDates()
    {
        return $this->hasMany('\App\Models\CutiKaryawanDate')->orderBy('tanggal_cuti', 'ASC');
    }
}
