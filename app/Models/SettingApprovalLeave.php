...
class SettingApprovalLeave extends Model
{
    ...
    {
        return $this->hasMany('\App\Models\SettingApprovalPaymentRequestItem', 'setting_approval_id', 'id');
    }
    ...
    {
        return $this->hasMany('\App\Models\SettingApprovalOvertimeItem', 'setting_approval_id', 'id');
    }
    ...
    {
        return $this->hasMany('\App\Models\SettingApprovalMedicalItem', 'setting_approval_id', 'id');
    }
