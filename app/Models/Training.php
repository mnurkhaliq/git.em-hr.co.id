...
class Training extends Model
{
    ...
    {
        return $this->hasMany('App\Models\TrainingTransportation', 'training_id', 'id')->orderBy('date');
    }

    public function training_allowance()
    {
        return $this->hasMany('App\Models\TrainingAllowance', 'training_id', 'id')->orderBy('date');
    }

    public function training_daily()
    {
        return $this->hasMany('App\Models\TrainingDaily', 'training_id', 'id')->orderBy('date');
    }

    public function training_other()
    {
        return $this->hasMany('App\Models\TrainingOther', 'training_id', 'id')->orderBy('date');
    }
