...
class CreateHistoryApprovalTrainingTable extends Migration {
	...
	public function up()
	{
		Schema::create('history_approval_training', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('history_approval_training');
	}
