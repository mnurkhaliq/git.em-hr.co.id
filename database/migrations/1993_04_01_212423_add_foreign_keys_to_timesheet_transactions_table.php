...
class AddForeignKeysToTimesheetTransactionsTable extends Migration {
	...
	public function down()
	{
		Schema::table('timesheet_transactions', function(Blueprint $table)
		{
			$table->dropForeign('timesheet_transactions_timesheet_activity_id_foreign');
			$table->dropForeign('timesheet_transactions_timesheet_category_id_foreign');
			$table->dropForeign('timesheet_transactions_timesheet_period_id_foreign');
		});
	}
