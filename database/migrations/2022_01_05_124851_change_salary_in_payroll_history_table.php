...
class ChangeSalaryInPayrollHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('payroll_history', function (Blueprint $table) {
            ...
            $table->bigInteger('gross_income_per_month')->nullable()->default(0)->change();
            ...
            $table->bigInteger('total_deductions')->nullable()->change();
