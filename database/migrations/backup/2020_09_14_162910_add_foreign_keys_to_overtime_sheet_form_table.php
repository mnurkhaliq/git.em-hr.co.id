...
class AddForeignKeysToOvertimeSheetFormTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('overtime_payroll_type_id', 'overtime_sheet_form_overtime_payroll_type_id_foreign')->references('id')->on('overtime_payroll_types')->onUpdate('CASCADE')->onDelete('CASCADE');
		});
	}
