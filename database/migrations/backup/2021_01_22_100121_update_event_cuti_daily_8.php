...
class UpdateEventCutiDaily8 extends Migration
{
    /**
     * Run the migrations.
     *
...
update user_cuti a inner join users b on a.user_id = b.id inner join cuti c on a.cuti_id = c.id set a.sisa_cuti=a.sisa_cuti+c.Kuota, a.kuota=a.kuota+c.Kuota
where b.join_date = now() and (b.resign_date IS NULL or b.resign_date > now()) and c.master_cuti_type_id=4 and c.cutoffmonth is not null;
