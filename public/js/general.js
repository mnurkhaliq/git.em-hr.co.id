...
$('#data_table3_no_search').DataTable({
  dom: 'Bfrtip',
  searching: false,
  pageLength: 30,
  buttons: [
...
data_table_no_search = $("#data_table_no_search").DataTable({
    dom: 'Bfrtip',
    searching: false,
    pageLength: 30,
    fixedHeader: true,
...
data_table_no_search_with_page_length_check = $("#data_table_no_search_with_page_length_check").DataTable({
    dom: 'Blfrtip',
    searching: false,
    pageLength: 20,
    fixedHeader: true,
...
data_table_no_pagging = $("#data_table_no_pagging").DataTable({
    dom: 'Bfrtip',
    searching: false,
    pageLength: 30,
    fixedHeader: true,
