...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-cash-advance" enctype="multipart/form-data" action="{{ route('administrator.approval.cash-advance.transferClaim', $data->id) }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        {{ csrf_field() }}
                                ...
                                <tbody class="table-content-lembur">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <input type="text" name="nominal_approve[{{ $item->id }}]" {{$history->is_approved_claim ? 'readonly="true"' : 'readonly="true"' }} class="form-control price_format nominal_approve" value="{{ $item->actual_amount }}" placeholder="Nominal Approve"/>
                                            @endif
                                        </td>
                                        <td>
                            ...
                            @if($data->payment_method == 'Bank Transfer' && $data->status_claim==2 && ($total_amount_claimed != $total_amount_approved))
                                <div class="col-md-3">
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" {{$data->is_transfer_claim==1 ? 'checked disabled' : ''}} {{$total_amount_claimed < $total_amount_approved ? 'required' : ''}} id="is_transfer_claim" name="is_transfer_claim" value="1" disabled>
                                ...
                                <div class="col-md-6" id="transfer_proof_claim_div">
                                    <div class="form-group">
                                        <label class="col-md-12">Transfer Proof</label>
                                        <div class="col-md-8">
                                            <input type="file" id="transfer_proof_claim_by_admin" name="transfer_proof_claim_by_admin" {{$data->is_transfer_claim==1 ? 'disabled' : ''}} {{$total_amount_claimed > $total_amount_approved ? '' : ''}} class="form-control " accept="image/*, application/pdf" disabled/>
                                        </div>
                                        <div class="col-md-4">
                                            <a onclick="preview()" class="btn btn-default preview" style="display: none"><i class="fa fa-search-plus"></i> View</a>
                                        </div>
                        ...
                        <a href="{{ route('administrator.approval.cash-advance.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
...
<script type="text/javascript">
    ...
    console.log(parseInt(approved) < parseInt(total));
    if(total >= 0){
