...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-cuti" enctype="multipart/form-data" action="{{ route('administrator.approval.leave-custom.proses') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" readonly="true" class="form-control jabatan" value="{{ isset($datas->karyawan->structure->position) ? $datas->karyawan->structure->position->name:''}}{{ isset($datas->karyawan->structure->division) ? ' - '. $datas->karyawan->structure->division->name:''}}{{ isset($datas->karyawan->structure->title) ? ' - '. $datas->karyawan->structure->title->name:''}}">
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="col-md-12">Position</label>
                                <div class="col-md-6">
                                    <input type="text" readonly="true" class="form-control" value="{{ isset($datas->backup_karyawan->structure->position) ? $datas->backup_karyawan->structure->position->name:''}}{{ isset($datas->backup_karyawan->structure->division) ? ' - '. $datas->backup_karyawan->structure->division->name:''}}{{ isset($datas->backup_karyawan->structure->title) ? ' - '. $datas->backup_karyawan->structure->title->name:''}}">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="{{ route('administrator.approval.leave-custom.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
