                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->is_approved === NULL and $item->status < 2)
                                                <a href="{{ route('administrator.approval.overtime-custom.detail', $item->id) }}" class="btn btn-info btn-xs"> <i class="fa fa-arrow-right"></i> process</a>
                                            @else
                                                <a href="{{ route('administrator.approval.overtime-custom.detail', $item->id) }}" class="btn btn-info btn-xs"> <i class="fa fa-search-plus"></i> detail</a>
                                            @endif
                                        ...
                                        <td>
                                            @if($item->status == 2)
                                                ...
                                                @if(cek_level_overtime_up($item->overtimeSheet->id))
                                                    ...
                                                    <a href="{{ route('administrator.approval.overtime-custom.claim', $item->id) }}" class="btn btn-info btn-xs"> <i class="fa fa-arrow-right"></i> process claim</a>
                                                @endif
                                                @elseif($item->is_approved_claim != NULL and $item->status_claim >= 1)
                                                    <a href="{{ route('administrator.approval.overtime-custom.claim', $item->id) }}" class="btn btn-info btn-xs"> <i class="fa fa-search-plus"></i> claimed detail</a>
                                                @endif
                                            @endif
                                        </td>
                                    </tr>
