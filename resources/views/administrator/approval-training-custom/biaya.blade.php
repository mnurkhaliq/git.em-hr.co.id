...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-actual-bill" enctype="multipart/form-data" action="{{ route('administrator.approval.training-custom.prosesClaim') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        ?>
                            ...
                            <table class="table data_table_no_pagging display nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th colspan="6" style="background-color: rgba(120,130,140,.13)"><h5 style="margin: 0; font-weight: bold; text-transform: uppercase;">1. Acommodation & Transportation</h5></th>
                                    </tr>
                                    <tr>
                                        <th>Date</th>
                                        <th>Description</th>
                        ...
                        <div class="table-responsive">
                            <table class="table data_table_no_pagging display nowrap" cellspacing="0" width="100%" >
                                <thead>
                                    <tr>
                                    <th colspan="10" style="background-color: rgba(120,130,140,.13)"><h5 style="margin: 0; font-weight: bold; text-transform: uppercase;">2. Meal Allowance</h5></th>
                                    </tr>
                                    <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table data_table_no_pagging display nowrap" cellspacing="0" width="100%" >
                                <thead>
                                    <tr>
                                    <th colspan="6" style="background-color: rgba(120,130,140,.13)"><h5 style="margin: 0; font-weight: bold; text-transform: uppercase;">3. Daily Allowance</h5></th>
                                    </tr>
                                    <tr>
                                        <th>Date</th>
                        ...
                        <table class="table data_table_no_pagging display nowrap" cellspacing="0" width="100%" >
                            <thead>
                                <tr>
                                    <th colspan="6" style="background-color: rgba(120,130,140,.13)"><h5 style="margin: 0; font-weight: bold; text-transform: uppercase;">4. Other's</h5></th>
                                </tr>
                                <tr>
                                    <th>Date </th>
                                    <th>Description </th>
