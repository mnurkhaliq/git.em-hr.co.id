...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-training" enctype="multipart/form-data" action="{{ route('administrator.approval.training-custom.proses') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="pesawat">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label style="font-weight: normal;">
                                            <input type="radio" readonly="true" {{ $data->tipe_perjalanan == 'Sekali Jalan' ? 'checked' : '' }} name="tipe_perjalanan" value="Sekali Jalan"> One Way
                                        </label> &nbsp;&nbsp;
                                        <label style="font-weight: normal;">
                                            <input type="radio" readonly="true" {{ $data->tipe_perjalanan == 'Pulang Pergi' ? 'checked' : '' }} name="tipe_perjalanan" value="Pulang Pergi"> Round Trip
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" placeholder="Departure Date" value="{{ $data->tanggal_berangkat }}" name="tanggal_berangkat" readonly class="form-control">
                                    </div>
                                    <div style="float: left; width: 5px;padding-top:10px;"> / </div>
                                    <div class="col-md-1">
                                        <input type="text" class="form-control time" value="{{ date("H:i",strtotime($data->waktu_berangkat))}}" placeholder="Time" readonly name="waktu_berangkat" />
                                    </div>
                                    <div style="float: left; width: 5px;padding-top:10px;"> - </div>
                                    <div class="col-md-2"><input type="text" placeholder="Return Date" name="tanggal_pulang" class="form-control" readonly value="{{ $data->tanggal_pulang }}">
                                    </div>
                                    <div style="float: left; width: 3px;padding-top:10px;"> / </div>
                                    <div class="col-md-1">
                                        <input type="text" class="form-control time_picker" value="{{ 
                                        date("H:i",strtotime($data->waktu_pulang)) }}" placeholder="Time" readonly name="waktu_pulang" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="rute_dari_berangkat" value="{{ $data->rute_dari_berangkat }}" class="form-control" readonly id="rute_dari_berangkat" placeholder="From">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" name="rute_tujuan_berangkat" value="{{ $data->rute_tujuan_berangkat }}"  class="form-control" readonly id="rute_tujuan_berangkat" placeholder="To">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <label style="font-weight: normal;">
                                            <input type="radio" name="tipe_kelas_berangkat" value="Ekonomi" {{ $data->tipe_kelas_berangkat == 'Ekonomi' ? 'checked' : '' }} /> Economy
                                        </label> 
                                        <label style="font-weight: normal;">
                                            <input type="radio" name="tipe_kelas_berangkat" value="Bisnis"  {{ $data->tipe_kelas_berangkat == 'Bisnis' ? 'checked' : '' }}/> Business
                                        </label> 
                                    </div>
                                    <div class="col-md-6"> 
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Note Approval</label>
                                    @if($history->note != NULL)
                                    <div class="col-md-8"> 
                                        <input type="text" readonly="true" class="form-control noteApproval" value="{{ $history->note }}">
                                    </div>
                                    @else
                                    <div class="col-md-8"> 
                        ...
                        <div class="col-md-12" style="padding-left: 0;">
                            <a href="{{ route('administrator.approval.training-custom.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
...
<script type="text/javascript">
    ...
    $("#btn_approved").click(function(){
        bootbox.confirm('Approve Employee Business Trip /Training ?', function(result){
    ...
    $("#btn_tolak").click(function(){
        bootbox.confirm('Reject Employee Business Trip /Training ?', function(result){
