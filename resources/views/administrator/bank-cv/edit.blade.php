...
<div id="page-wrapper">
    ...
    <div class="row">
        <form class="form-horizontal" id="form-bank-cv" enctype="multipart/form-data" action="{{ route('administrator.bank-cv.update', $data->id ) }}" method="POST">
                ...
                <div class="white-box">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="biodata">
                            ...
                            <div class="col-md-6" style="padding-left: 0">
                                <div class="form-group">
                                    <div class="col-md-12" id="default_photos">
                                        ...
                                        <img src="{{ asset('storage/file-cv-photos/'. $data->photos) }}" style="width: 200px;" />
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="{{ strtoupper($data->nik) }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Name <span class="text-danger">*</span></label>
                                    <div class="col-md-10">
                                        <input type="text" name="name" class="form-control" value="{{ strtoupper(old('name', $data->name)) }}"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="gender" class="form-control">
                                            ...
                                            @foreach(['Male', 'Female'] as $item)
                                                <option {{ old('gender', $data->gender) == $item ? 'selected' : '' }}>{{ $item }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="phone_number" class="form-control" value="{{ old('phone_number', $data->phone_number) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Born Year</label>
                                    <div class="col-md-10">
                                        <input type="number" name="born_year" class="form-control" value="{{ old('born_year', $data->born_year) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" style="padding-left: 0">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="{{ $data->input_date }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Skill</label>
                                    <div class="col-md-10">
                                        <input type="text" name="skill" class="form-control" value="{{ old('skill', implode(',', $data->tags->pluck('tag')->toArray())) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Expected Salary</label>
                                    <div class="col-md-10">
                                        <input type="number" name="salary" class="form-control" value="{{ old('salary', $data->salary) }}"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Created By</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="{{ $data->createdBy ? $data->createdBy->nik.' - '.$data->createdBy->name : 'Applicant' }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Updated By</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="{{ $data->updatedBy ? $data->updatedBy->nik.' - '.$data->updatedBy->name : 'Applicant' }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            @if(!empty($data->cv))
                                            <a onclick="show_image('{{ $data->cv }}')" class="btn btn-default show_image"><i class="fa fa-search-plus"></i> View</a>
                                            @endif
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="option">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <select name="option[{{ $option->id }}]" class="form-control">
                                            ...
                                            @foreach($option->values as $value)
                                                <option value="{{ $value->id }}" {{ (isset(old('option')[$option->id]) ? old('option')[$option->id] : ($data->options->where('bank_cv_option_id', $option->id)->first() ? $data->options->where('bank_cv_option_id', $option->id)->first()->bank_cv_option_value_id : '')) == $value->id ? 'selected' : '' }}>{{ $value->value }}</option>
                                            @endforeach
                                        </select>
                                        @else
                                        <input type="text" name="option[{{ $option->id }}]" class="form-control" value="{{ isset(old('option')[$option->id]) ? old('option')[$option->id] : ($data->options->where('bank_cv_option_id', $option->id)->first() ? $data->options->where('bank_cv_option_id', $option->id)->first()->bank_cv_option_value : '') }}">
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6" style="padding-left: 0">
                                <div class="form-group">
                                    <label class="col-md-12">{{ ucwords($option->date_name) }}</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="{{ $data->options->where('bank_cv_option_id', $option->id)->first() ? date('Y-m-d', strtotime($data->options->where('bank_cv_option_id', $option->id)->first()->updated_at)) : '' }}" disabled>
                                    </div>
                                </div>
                            </div>
                            @endif
...
@section('footer-script')
    ...
    <script type="text/javascript">
        ...
        function show_image(img)
        {
            ...
            if(ext === 'pdf') {
                $('#modalcontent').html('<embed src="{{ asset('storage/file-cv/')}}/'+ img +'" frameborder="0" width="100%" height="400px">');
                $('#modal_file').modal('show');
            } else if(images.includes(ext)) {
                $('#modalcontent').html('<img src="{{ asset('storage/file-cv/')}}/'+ img +'" style = \'width: 100%;\' />');
                $('#modal_file').modal('show');
            } else {
