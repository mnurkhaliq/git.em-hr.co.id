                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.bank.edit', $item->id) }}"style="float: left; margin-right:5px" > <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
