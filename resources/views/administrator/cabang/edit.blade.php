...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <!-- .row -->
            <div class="row">
                <form id="form" class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.cabang.update', $data->id) }}" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="timezone" id="timezone" class="form-control">
                                        <!-- <option value="">{{old('timezone',$data->timezone)}}</option> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="fax" class="form-control" value="{{ old('fax',$data->fax) }}">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <script>
        ...
        // $('#branch_id').val("{{old('timezone',$data->timezone)}}");
        document.getElementById('timezone').value = "{{old('timezone',$data->timezone)}}"
    </script>
@endsection
