                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->timezone }}</td>
                                        <td>
                                            <a href="{{ route('administrator.cabang.edit', $item->id) }}" style="float: left; margin-right:5px" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> edit </a>
                                            <form action="{{ route('administrator.cabang.destroy', $item->id) }}" onsubmit="return confirm('Delete this data?')" method="post" style="margin-left: 5px;">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}                                               
