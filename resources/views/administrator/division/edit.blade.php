            ...
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.division.update', $data->id) }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="col-md-6">
                        <input name="idDivision" type="hidden" id="idDivision" value="{{$data->id}}">
                            <div class="form-group">
                                <label class="col-md-12">Division Name</label>
                                <div class="col-md-10">
                                    <input id="divName" type="text" name="name" class="form-control form-control-line nameCan" value="{{ $data->name }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input id="divCode" type="text" name="code" class="form-control form-control-line codeCan" value="{{ $data->code }}">
                                </div>
