    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <a href="{{ route('administrator.exit-custom.create') }}" class="btn btn-success btn-sm pull-right m-l-20 waves-effect waves-light"> <i class="fa fa-plus"></i> ADD EXIT INTERVIEW</a>
                @endif
                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    <tr>
                                        ...
                                        <td>
                                           <a href="{{ route('administrator.exit-custom.edit', $item->id) }}" class="btn btn-info btn-xs"><i class="fa fa-search-plus"></i> detail</a>
                                           @if($item->status < 3)
                                                <a href="{{ route('administrator.exit-custom.clearance', $item->id) }}" class="btn btn-info btn-xs"><i class="fa fa-search-plus"></i> exit clearance</a>
                                            @endif
