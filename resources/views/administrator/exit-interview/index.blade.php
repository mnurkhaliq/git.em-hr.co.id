                                ...
                                @foreach($data as $no => $item)
                                  @if(isset($item->user->name))
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->status == 1)
                                            <a href="{{ route('administrator.exit-interview.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-arrow-right"></i> proces</button></a>
                                            @else
                                            <a href="{{ route('administrator.exit-interview.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-arrow-right"></i> detail</button></a>
                                            @endif
                                        </td>
                                    </tr>
                                  @endif
