                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="interview">
                                ...
                                <div class="col-md-6" style="padding-left: 0;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" readonly="true" class="form-control department" value="{{ $data->user->join_date ? date('Y-m-d', strtotime($data->user->join_date)) : null  }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" readonly="true" class="form-control" value="{{ $data->last_work_date}}">
                                        </div>
                                    </div>
