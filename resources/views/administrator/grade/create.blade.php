...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-inline" enctype="multipart/form-data" action="{{ route('administrator.grade.store') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="col-md-8" id="gradeDiv">
                            <table class="table" id="gradeTable">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td><input autocomplete="off" required name="gradeName" id="gradeName" type="text" class="form-control gradeName"></td>
                                    <td><input autocomplete="off" onkeypress="checkAngkaLow(1)" required name="salaryLow" id="salaryLow" type="text" class="form-control subSalaryLow spanLow1" placeholder="Lowest"></br><span id="alertLow1" style="display:none;color:red;font-style:italic;">This value has to be numeric</span></td>
                                    <td><input autocomplete="off" onkeypress="checkAngkaHigh(1)" required name="salaryHigh" id="salaryHigh" type="text" class="form-control subSalaryHigh spanHigh1" placeholder="Highest"></br><span id="alertHigh1" style="display:none;color:red;font-style:italic;">This value has to be numeric</span></td>
                                ...
                                <tr id="subGradeInput" style="display:none">
                                    ...
                                    <td><button id="addSub" type="button" class="btn btn-sm btn-success waves-effect waves-light m-r-10 addSub"><i class="fa fa-plus"></i></button> <button id="delSub" style="display:none" type="button" class="btn btn-sm btn-danger"><i class="fa fa-minus"></i></button></td>
                                </tr>
                            </table>
                            <table class="table" id="gradeBenefit">
                                ...
                                <tr>
                                    <td colspan="5"><textarea name="benefit" id="benefit" cols="30" rows="10" class="form-control"></textarea></td>
                                </tr>
                            </table>
                        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.addSub').click(function(){
            ...
            newRow += '<td>' + lineNo + '</td>';
            newRow += '<td><input required autocomplete="off" name="subGradeName[]" id="subGradeName" type="text" class="form-control"></td>';
            newRow += '<td><input required autocomplete="off" onkeypress="checkAngkaLow('+lineNo+')" onkeyup="rangeLow()" name="subSalaryLow[]" id="subSalaryLow" type="text" class="form-control subSalaryLow spanLow'+lineNo+' valLow'+lineNo+'" placeholder="Lowest"></br><span id="alertLow'+lineNo+'" style="display:none;color:red;font-style:italic;">This value has to be numeric</span><span id="valLow'+lineNo+'" style="display:none;color:red;font-style:italic;"></span></td>';
            newRow += '<td><input required autocomplete="off" onkeypress="checkAngkaHigh('+lineNo+')" onkeyup="rangeHigh()" name="subSalaryHigh[]"id="subSalaryHigh" type="text" class="form-control subSalaryHigh spanHigh'+lineNo+' valHigh'+lineNo+'" placeholder="Highest"></br><span id="alertHigh'+lineNo+'" style="display:none;color:red;font-style:italic;">This value has to be numeric</span><span id="valHigh'+lineNo+'" style="display:none;color:red;font-style:italic;"></span></td>';
            newRow += '<td></td>';
            newRow += '</tr>';
