                        ...
                        <table id="data_table_no_search" class="display nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(!empty($item->file))
                                            <a href="{{ route('administrator.internal-memo.download', $item->id) }}" target="_blank"><i class="fa fa-link"></i></a></td>
                                        @else
                                    ...
                                    <td>
                                        <a href="{{ route('administrator.internal-memo.edit', $item->id) }}" style="float: left; margin-right:5px"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
