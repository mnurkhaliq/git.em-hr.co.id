...
<body>
	...
	<table>
        ...
        <tr>
			...
			<td>: {{ $data->status_contract }}</td>
        </tr>
        <tr>
			<td>Start Date Contract</td>
			<td>: {{ $data->start_date_contract }}</td>
        </tr>
        <tr>
			<td>End Date Contract</td>
			<td>: {{ $data->end_date_contract }}</td>
		</tr>
    ...
    <br />
	<h4 style="background: #eee; padding: 10px; margin-bottom: 0; ">Training</h4>
	<hr>
	<br />
	<table class="table-border">
		<tr>
	...
	<br />
	<h4 style="background: #eee; padding: 10px; margin-bottom: 0; ">Leave</h4>
	<hr>
	<br />
	<table class="table-border">
		<tr>
