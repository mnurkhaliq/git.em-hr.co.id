                    ...
                    <div class="tab-content">
                            ...
                            @if(get_setting('struktur_organisasi') == 3)
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <option value="{{ $item["id"] }}" {{ old('branch_id', $data->cabang_id) == $item["id"] ? 'selected' : '' }}>{{ $item["name"] }}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="structure_organization_custom_id">
                                            ...
                                            <option value="{{ $item["id"]}}" {{ old('structure_organization_custom_id', $data->structure_organization_custom_id) == $item["id"] ? 'selected' : '' }}>{{ $item["name"] }}</option>
                                            @endforeach
                                        </select> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="custom_project_id">
                                            ...
                                            <option value="{{ $item["id"] }}" {{ old('custom_project_id', $data->custom_project_id) == $item["id"] ? 'selected' : '' }}>{{ $item["name"] }}</option>
                                            @endforeach
                                        </select> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="branch_type">
                                            ...
                                            <option {{ old('branch_type', $data->branch_type) == $item ? ' selected' : '' }}>{{ $item }}</option>
                                            @endforeach
                                        </select> 
                                    </div>
                                </div>
                                 <div class="form-group section-cabang" style="{{ old('branch_type', $data->branch_type) == "HO" ? 'display:none' : ''  }}">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" name="cabang_id">
                                            ...
                                            <option value="{{ $item->id }}" {{ old('cabang_id', $data->cabang_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select> 
                                    </div>
                                    <div class="clearfix" /></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="empore_organisasi_direktur">
                                            ...
                                            <option value="{{ $item->id }}" {{ old('empore_organisasi_direktur', $data->empore_organisasi_direktur) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select> 
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="ptkp" id="ptkp">
                                        ...
                                        <option value="TK-0" {{ old('ptkp', $data->ptkp) == "TK-0" ? 'selected' : '' }}>TK-0</option>
                                        <option value="K-0" {{ old('ptkp', $data->ptkp) == "K-0" ? 'selected' : '' }}>K-0</option>
                                        <option value="K-1" {{ old('ptkp', $data->ptkp) == "K-1" ? 'selected' : '' }}>K-1</option>
                                        <option value="K-2" {{ old('ptkp', $data->ptkp) == "K-2" ? 'selected' : '' }}>K-2</option>
                                        <option value="K-3" {{ old('ptkp', $data->ptkp) == "K-3" ? 'selected' : '' }}>K-3</option>
                                    </select>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="biodata">
                            ...
                            <div class="col-md-6" style="padding-left: 0">
                                <div class="form-group">
                                    <div class="col-md-12 result_default_photo">
                                        @if(!empty($data->foto))
                                    ...
                                    <div class="col-md-12 result_change_photo" style="display: none">
                                        <img id="result_change_photo" style="width: 200px;" />
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="name" style="text-transform: uppercase"  class="form-control " value="{{ old('name', $data->name) }}"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="tanggal_lahir" value="{{ old('tanggal_lahir', $data->tanggal_lahir) }}" class="form-control datepicker2"> </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control " name="blood_type" value="{{ old('blood_type', $data->blood_type) }}" /> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="join_date" name="join_date" value="{{ old('join_date', $data->join_date) }}" class="form-control  datepicker2" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group contract_container {{old('organisasi_status', $data->organisasi_status) && old('organisasi_status', $data->organisasi_status) != 'Permanent'?'':'hidden'}}">
                                    <label class="col-md-12">Last Work/Login Date(yyyy-mm-dd)</label>
                                    <div class="col-md-10">
                                        <input type="text" name="inactive_date" class="form-control  datepicker2" value="{{ old('inactive_date', $data->inactive_date) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control " name="organisasi_status" id="organisasi_status">
                                            ...
                                            @foreach(['Permanent', 'Contract', 'Internship', 'Outsource', 'Freelance'] as $item)
                                            <option {{ old('organisasi_status', $data->organisasi_status) == $item ? 'selected' : '' }}>{{ $item }}</option>
                                            @endforeach
                                        </select> 
                                    </div>
                                </div>
                                <div class="form-group row contract_container {{old('organisasi_status', $data->organisasi_status) && old('organisasi_status', $data->organisasi_status) != 'Permanent'?'':'hidden'}}">
                                    <div class="col-md-1">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="start_date_contract" class="form-control  datepicker2" value="{{ old('start_date_contract', (($data->start_date_contract == '0000-00-00' || $data->start_date_contract == null) ? '' : date('Y-m-d', strtotime($data->start_date_contract)))) }}">
                                    </div>
                                    <div class="col-md-3">
                                        <label>End Date(yyyy-mm-dd)</label>
                                        <input type="text" name="end_date_contract" class="form-control  datepicker2" value="{{ old('end_date_contract', (($data->end_date_contract == '0000-00-00' || $data->end_date_contract == null) ? '' : date('Y-m-d', strtotime($data->end_date_contract)))) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6" style="padding-left: 0">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="npwp_number" value="{{ old('npwp_number', $data->npwp_number) }}" class="form-control ">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="kk_number" value="{{ old('kk_number', $data->kk_number) }}" class="form-control ">
                                    </div>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="mobile_1" value="{{ old('mobile_1', $data->mobile_1) }}" class="form-control "> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Mobile 2</label>
                                    <div class="col-md-10">
                                        <input type="number" name="mobile_2" value="{{ old('mobile_2', $data->mobile_2) }}" class="form-control "> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Emergency Contact Name</label>
                                    <div class="col-md-10">
                                        <input type="text" name="emergency_name" value="{{ old('emergency_name', $data->emergency_name) }}" class="form-control "> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Emergency Contact Relationship</label>
                                    <div class="col-md-10">
                                        <input type="text" name="emergency_relationship" value="{{ old('emergency_relationship', $data->emergency_relationship) }}" class="form-control "> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Emergency Contact Number</label>
                                    <div class="col-md-10">
                                        <input type="number" name="emergency_contact" value="{{ old('emergency_contact', $data->emergency_contact) }}" class="form-control "> </div>
                                </div>
                               <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if(!empty($data->foto_ktp))
                                                <a onclick="show_ktp('{{ $data->foto_ktp }}')" class="btn btn-default show_ktp"><i class="fa fa-search-plus"></i> View</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if(!empty($data->foto_kk))
                                                <a onclick="show_kk('{{ $data->foto_kk }}')" class="btn btn-default show_kk"><i class="fa fa-search-plus"></i> View</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if(!empty($data->foto_sim))
                                                <a onclick="show_sim('{{ $data->foto_sim }}')" class="btn btn-default show_sim"><i class="fa fa-search-plus"></i> View</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if(!empty($data->foto_cv))
                                                <a onclick="show_cv('{{ $data->foto_cv }}')" class="btn btn-default show_cv"><i class="fa fa-search-plus"></i> View</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
        ...
        window.onload = function() {
            ...
            if (window.File && window.FileList && window.FileReader) {
                ...
                filesInput.addEventListener("change", function(event) {
                    var files = event.target.files; //FileList object
                    if (files.length) {
                        $(".result_default_photo").hide();
                        $(".result_change_photo").show();
                    } else {
                        $(".result_change_photo").hide();
                        $(".result_default_photo").show();
                    }
                    for (var i = 0; i < files.length; i++) {
                        var file = files[i];
                        //Only pics and pdf
    ...
    $('#DivVisitType').on('change', function() {
       ...
       else  
      {
        ...
        $("#add_modal_certification").click(function(){
            ...
            var photo                       = document.getElementById('modal-certificate_photo').files[0];
            ...
            if (photo) {
                ...
                reader.onload = function () {
                    ...
                    el +='<td>'+ modal_description +'</td>';
                    el +='<td><a onclick="show_certificate_base64(\''+ reader.result +'\')" class="btn btn-default btn-xs" style="height: 35px;width: 100px"><i class="fa fa-search-plus"></i>View</a></td>';
                    ...
                    el +='<input type="hidden" name="certification[certificate_photo_base64][]" value="'+ reader.result +'" />';
                    ...
                    $('form.frm-modal-certification input[type="file"]').val('')
                ...
                el +='<input type="hidden" name="certification[score][]" value="'+ modal_score +'" />';
                el +='<input type="hidden" name="certification[description][]" value="'+ modal_description +'" />';
                el +='<input type="hidden" name="certification[certificate_photo_base64][]" value="" />';
        ...
        function defaultDependent() {
            ...
            var el = '<tr>';
            var modal_nama                  = "{{ $item->nama }}"
            var modal_hubungan              = "{{ $item->hubungan }}"
            var modal_contact               = "{{ $item->contact }}"
            var modal_tempat_lahir          = "{{ $item->tempat_lahir }}"
            var modal_tanggal_lahir         = "{{ $item->tanggal_lahir }}"
            var modal_tanggal_meninggal     = "{{ $item->tanggal_meninggal }}"
            var modal_jenjang_pendidikan    = "{{ $item->jenjang_pendidikan }}"
            var modal_pekerjaan             = "{{ $item->pekerjaan }}"
            var modal_tertanggung           = "{{ $item->tertanggung }}"
        ...
        function defaultEducation() {
            ...
            var el = '<tr>';
            var modal_pendidikan            = "{{ $item->pendidikan }}"
            var modal_fakultas              = "{{ $item->tahun_awal }}"
            var modal_tahun_awal            = "{{ $item->tahun_akhir }}"
            var modal_tahun_akhir           = "{{ $item->fakultas }}"
            var modal_jurusan               = "{{ $item->jurusan }}"
            var modal_nilai                 = "{{ $item->nilai }}"
            var modal_kota                  = "{{ $item->kota }}"
        ...
        function defaultCertification() {
            ...
            var el = '<tr>';
            var modal_name                  = "{{ $item->name }}"
            var modal_date                  = "{{ $item->date }}"
            var modal_organizer             = "{{ $item->organizer }}"
            var modal_certificate_number    = "{{ $item->certificate_number }}"
            var modal_score                 = "{{ $item->score }}"
            var modal_description           = "{{ $item->description }}"
            var photo                       = "{{ $item->certificate_photo }}"
            ...
            el +='<td>'+ modal_description +'</td>';
            if (photo) {
                el +='<td><a onclick="show_certificate(\''+ photo +'\')" class="btn btn-default btn-xs" style="height: 35px;width: 100px"><i class="fa fa-search-plus"></i>View</a></td>';
            } else {
                el +='<td></td>';
            }
            el +='<input type="hidden" name="certification[name][]" value="'+ modal_name +'" />';
            ...
            el +='<input type="hidden" name="certification[score][]" value="'+ modal_score +'" />';
            el +='<input type="hidden" name="certification[description][]" value="'+ modal_description +'" />';
            el +='<input type="hidden" name="certification[certificate_photo_base64][]" id="certificate_photo_base64_{{ $item->id }}" />';
            
            $('.certification_table').append(el);
            
            if (photo) {
                toDataURL("{{ asset('storage/certificate/').'/'.$item->certificate_photo }}", function(dataUrl) {
                    $('#certificate_photo_base64_{{ $item->id }}').val(dataUrl);
                });
            }
        ...
        $("#marital_status, #jenis_kelamin").change();
