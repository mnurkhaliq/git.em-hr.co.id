    ...
    <script>
        ...
        function loadData(){
            ...
            t = $("#mytable").DataTable({
                ...
                scrollCollapse: true,
                scrollX: true,
                ajax: {"url": "{{ route('ajax.table.kpi_item.admin') }}", "type": "GET"},
                columns: [
                    {
                        "data": "id",
                        "orderable": false,
                    ...
                    { "data": "period","name": "kpi_periods.start_date"},
                    { "data": "min_rate"},
                    { "data": "max_rate"},
                    { "data": "weight_setting","name":"ss.weightage"},
                    { "data": "count", "searchable": false},
                    { "data": "status_setting", "searchable": false},
                    { "data": "is_lock", "searchable": false},
                ...
                columnDefs:[

                    {
                        ...
                        "render": function (data, type, row) {
                            // here you can convert data from base64 to hex and return it
                            if (data == 1) {
                                data='<center><span class="text-danger" data-toggle="tooltip" data-placement="bottom"  title="Period is locked" style="font-size: 25px;"><i class="fa fa-lock"></i></span></center>';
                            } else {
                                data='';
                            }
                            return data
