...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-cuti" enctype="multipart/form-data" action="{{ route('administrator.leave.store') }}" method="POST" autocomplete="off">
                <div class="col-md-12"> 
                    <div class="white-box">
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-md-6">
                                    <select class="form-control" name="jenis_cuti" id="jenis_cuti" required>
                                        ...
                                        @foreach(list_usere_cuti() as $item)
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('administrator.leave.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
