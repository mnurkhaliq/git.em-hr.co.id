...
@section('title', 'Add Loan Plafond Setting')
...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.loan-setting.store-plafond') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Add Plafond</h3>
                        <hr />
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" step="any" name="plafond" class="form-control price_format" required>
                            </div>
                            <div class="col-md-6" id="plafond_notice" style="color: red; display: none;" >
