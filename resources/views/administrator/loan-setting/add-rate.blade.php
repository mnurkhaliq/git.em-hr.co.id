...
@section('title', 'Add Loan Tenor & Interest Setting')
...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.loan-setting.store-rate') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Add Tenor & Interest</h3>
                        <hr />
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="number" step="any" name="interest" class="form-control" required>
                            </div>
                        </div>
