...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.medical-custom.store') }}" id="form-medical" method="POST"  autocomplete="off">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <a href="{{ route('administrator.medical-custom.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
...
<script type="text/javascript">
    ...
    $("#add").click(function(){
        ...
        var html =  '<tr class="oninput">'+
                        ...
                        '<td><input type="text" class="form-control" name="no_kwitansi[]" required /></td>'+
                        '<td><input type="number" class="form-control input" name="jumlah[]" required /></td>'+
                        '<td><input type="file" class="form-control input" name="file_bukti_transaksi[]"  accept="image/jpeg,image/gif,image/png,application/pdf,image/x-eps" required /></td>'+
