...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.medical-plafond.update', $data->id) }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control name" name="name" required>{{ $data->name }}</textarea>
                            </div>
                        </div>
