                                ...
                                <table id="data_table_no_search" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->name}}</td>
                                            <td>
                                                    <a href="{{ route('administrator.medical-plafond.edit', $item->id) }}" style="float: left; margin-right:5px"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
                                                    <form action="{{ route('administrator.medical-plafond.destroy', $item->id) }}" onsubmit="return confirm('Delete this data?')" method="post" style="margin-left: 5px;">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}                                               
                                ...
                                <table id="data_table2_no_search" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <a href="{{ route('administrator.medical-plafond.edit-medical-plafond', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
                                                    <a href="{{ route('administrator.medical-plafond.destroy-medical-plafond', $item->id) }}"> <button class="btn btn-danger btn-xs m-r-5"><i class="fa fa-trash"></i> delete</button></a>
                                                </td>
                                        </tr>
                                        @endforeach
