...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" autocomplete="off" id="form_payment" enctype="multipart/form-data" action="{{ route('administrator.payment-request-custom.store') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <a href="{{ route('administrator.payment-request-custom.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
