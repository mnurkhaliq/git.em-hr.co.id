                    ...
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            <div class="col-md-12" style="border: 1px solid #eee; padding: 15px">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" readonly="true" class="form-control autcomplete-atasan" placeholder="Select Superior" value="{{ isset($data->atasan->name) ? $data->atasan->nik .' - '. $data->atasan->name : '' }}">
                                    </div>
                                </div>
