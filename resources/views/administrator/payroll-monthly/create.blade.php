...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <form class="form-horizontal" id="form-payroll" autocomplete="off" enctype="multipart/form-data" action="{{ route('administrator.payroll-monthly.store') }}" method="POST">
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if(data!=null && !jQuery.isEmptyObject(data)){
                                        $("input[name='salary']").val(Math.round(data.salary.toString().split('.').join('')*prorate));
