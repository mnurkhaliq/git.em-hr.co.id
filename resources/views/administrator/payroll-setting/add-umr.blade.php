...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.payroll-setting.store-umr') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Add Setting Payroll UMR</h3>
                        <hr />
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                               <input type="text" name="value" class="form-control price_format" required>
                            </div>
                        </div>
