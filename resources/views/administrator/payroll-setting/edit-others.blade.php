...
@section('title', 'Form Setting Payroll Others')
    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Form Setting Payroll Others</h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                <ol class="breadcrumb">
                    <li><a href="javascript:void(0)">Dashboard</a></li>
                    <li class="active">Setting Payroll Others</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.payroll-setting.update-others', $data->id) }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Edit Setting Payroll Others</h3>
                        <hr />
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                               <input type="text" name="value" class="form-control price_format" value="{{ $data->value }}">
                            </div>
                        </div>
            ...
            <form id="cancel" action="{{ route('administrator.payroll-setting.index') }}" method="GET">
                <input type="hidden" name="tab" value="others" />
            </form>                 
        </div>
        <!-- /.row -->
        <!-- ============================================================== -->
