    ...
    <div class="container-fluid">
        <div class="row bg-title" style="overflow: inherit; ">
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <h4 class="page-title pull-left m-r-10">Payroll Default</h4>
                <form method="POST" action="{{ route('administrator.payroll.index') }}" id="filter-form" autocomplete="off">
                    ...
                    <div class="pull-right" style="padding-left:0;">
                        ...
                        <div class="btn-group m-r-5">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                ...
                                @if(!empty(\Session::get('year')))
                                    <li><a href="#" onclick="submit_filter_download()"><i class="fa fa-download"></i> Export YTD</a></li>
                                    <li><a href="#" onclick="submit_bukti_potong()" title="Download Bukti Potong"><i class="fa fa-download"></i> Export Bukti Potong</a></li>
                                @else
                        ...
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu" style="min-width: 10px; color: blue;">
                                ...
                                <li><a class="toggle-vis" data-column="4" style="color:blue;">Earning</a></li>
                                <li><a class="toggle-vis" data-column="5" style="color:blue;">Deductions</a></li>
                                <li><a class="toggle-vis" data-column="6" style="color:blue;">Take Home Pay</a></li>
                                <li><a class="toggle-vis" data-column="7" style="color:blue;">Type</a></li> 
                    ...
                    <div class="col-md-1 pull-right" style="padding: 0px;">
                        <div class="form-group m-b-0">
                            <select class="form-control form-control-line" name="employee_resign">
                                ...
                                <option {{ (\Session::get('employee_resign') == 'Active') ? 'selected' : '' }}>Active</option>
                                <option {{ (\Session::get('employee_resign') == 'Resign') ? 'selected' : '' }}>Resign</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-1 pull-right" style="padding-left:0;">
                        <div class="form-group m-b-0">
                            <select class="form-control form-control-line" name="payroll_type" onclick="filter_change()">
                                ...
                                <option value="NET" {{ (\Session::get('payroll_type') == 'NET') ? 'selected' : '' }}>NET</option>
                                <option value="GROSS" {{ (\Session::get('payroll_type') == 'GROSS') ? 'selected' : '' }}>GROSS</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-1 pull-right" style="padding-left:0;">
                    ...
                    <div class="col-md-1 pull-right" style="padding-left:0;">
                        <div class="form-group m-b-0">
                            <select class="form-control form-control-line" name="employee_status" onclick="filter_change()">
                                ...
                                <option {{ (\Session::get('employee_status') == 'Internship') ? 'selected' : '' }}>Internship</option>
                                <option {{ (\Session::get('employee_status') == 'Outsource') ? 'selected' : '' }}>Outsource</option>
                                <option {{ (\Session::get('employee_status') == 'Freelance') ? 'selected' : '' }}>Freelance</option>
                                <option {{ (\Session::get('employee_status') == 'Consultant') ? 'selected' : '' }}>Consultant</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 pull-right">
                        <div class="form-group m-b-0">
                            <input type="text" class="form-control form-control-line" name="name" value="{{ \Session::get('name') }}" placeholder="Nik / Name" onclick="filter_change()">
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(\Session::get('month') and \Session::get('year'))
                                                    ...
                                                    @if(!$item->is_lock)
                                                        <a href="{{ route('administrator.payroll.delete-history', $item->id) }}" onclick="return confirm('You would not be able to restore after, Delete this data?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> delete</a>
                                                    @endif
                                                @else
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="myModalLabel">Import Data Payroll @if(!empty(\Session::get('year')) && !empty(\Session::get('month'))) {{$bulanArray[\Session::get('month')]." ".\Session::get('year') }} @else Default @endif</h4> </div>
