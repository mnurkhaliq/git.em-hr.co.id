...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.payrollgross.update', $data->id) }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="col-md-3">Overtime</label>
                                <div class="col-md-6">
