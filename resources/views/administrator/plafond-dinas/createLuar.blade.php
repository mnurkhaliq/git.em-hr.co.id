...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.plafond-dinas.store-luar-negeri') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control price_format" name="tunjangan_makanan" required> 
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Daily Allowance / Day (USD)</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control price_format" name="tunjangan_harian" required> 
                            </div>
                        </div>
                        <div class="form-group">
