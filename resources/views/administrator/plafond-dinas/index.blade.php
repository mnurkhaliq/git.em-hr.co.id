    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Setting Business Trip</h4> 
            </div>
...
-->
                <ol class="breadcrumb">
                    ...
                    <li class="active">Setting Business Trip</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-md-12">
                <div class="white-box">
                     ...
                     <ul class="nav customtab nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#domestik" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true"><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"> Local Plafond</span></a></li>
                        <li role="presentation" class=""><a href="#luarnegeri" aria-controls="messages" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-email"></i></span> <span class="hidden-xs"> Abroad Plafond</span></a></li>
                        <li role="presentation" class=""><a href="#type" aria-controls="messages" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-email"></i></span> <span class="hidden-xs"> Type</span></a></li>
                        <li role="presentation" class=""><a href="#settlement" aria-controls="messages" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-email"></i></span> <span class="hidden-xs"> Setllement Duration</span></a></li>
                    </ul>

                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="domestik">
                            <h3 class="box-title m-b-0">Local Business Trip Allowance Setting</h3>
                                ...
                                <table id="data_table_no_search" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--<td>{{ format_idr($item->hotel) }}</td>-->
                                            <td>{{ $item->plafond_type}}</td>
                                            <td>{{ format_idr($item->tunjangan_makanan) }}</td>
                                            <td>{{ format_idr($item->tunjangan_harian) }}</td>
                                            <td>{{ $item->keterangan }}</td>
                                            <td>
                                                    <a href="{{ route('administrator.plafond-dinas.edit', $item->id) }}" style="float: left; margin-right:5px"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="luarnegeri">
                            <h3 class="box-title m-b-0">Abroad Business Trip Allowance Setting</h3>
                                ...
                                <table id="data_table2_no_search" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->keterangan }}</td>
                                            <td>
                                                    <a href="{{ route('administrator.plafond-dinas.edit-luar-negeri', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
                                                    <a href="{{ route('administrator.plafond-dinas.destroy-luar-negeri', $item->id) }}"> <button class="btn btn-danger btn-xs m-r-5"><i class="fa fa-trash"></i> delete</button></a>
                                                </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="type">
                            ...
                            <a href="{{ route('administrator.training-type.create') }}" class="btn btn-success btn-sm  hidden-sm waves-effect waves-light"> <i class="fa fa-plus"></i> ADD</a>
                            <br />
                            <div class="table-responsive">
                                <table id="data_table3_no_search" class="display nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach($data_type as $no => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('administrator.training-type.edit', $item->id) }}" style="float: left; margin-right:5px"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-edit"></i> edit</button></a>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="settlement">
                            ...
                            <br><br><br><br>
                            <h3 class="box-title m-b-0">Settlement Duration Setting</h3>
                            <form method="POST" id="form-setting" name="form_setting" enctype="multipart/form-data" action="{{ route('administrator.plafond-dinas.settlement-duration') }}" class="form-horizontal">
                                {{ csrf_field() }}
                                <div class="table-responsive">
                                    <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <div class="input-form">
                                                    <input type="number" min="0" class="form-control" name="setting[settlement_duration]" value="{{ get_setting('settlement_duration') ?: 10 }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
