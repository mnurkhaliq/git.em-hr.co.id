            ...
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.position.update', $data->id) }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        {{ csrf_field() }}
                        <div class="col-md-6">
                        <input name="idPosition" type="hidden" id="idPosition" value="{{$data->id}}">
                            <div class="form-group">
                                <label class="col-md-12">Position Name</label>
                                <div class="col-md-10">
                                    <input id="posName" type="text" name="name" class="form-control form-control-line nameCan" value="{{ $data->name }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input id="posCode" type="text" name="code" class="form-control form-control-line codeCan" value="{{ $data->code }}">
                                </div>
                        ...
                        <button id="savePos" type="submit" class="btn btn-sm btn-success waves-effect waves-light m-r-10"><i class="fa fa-save"></i> Save</button>
                        <br style="clear: both;" />
                        <div class="clearfix"></div>
                    </div>
                </div>    
