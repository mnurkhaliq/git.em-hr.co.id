...
@section('title', 'Province/Area Category')
    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Province/Area Category</h4> 
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Province/Area Category</li>
                </ol>
            </div>
        </div>
        <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Province/Area Category</h4> </div>
