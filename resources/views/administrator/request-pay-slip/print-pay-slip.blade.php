...
@foreach($dataArray as $k => $item)
	...
	<p><strong>PAYSLIP {{ $bulan[$k] }} {{ $tahun[$k]}}</strong></p>
	<br />
	<table style="width: 100%;">
		<tr>
			<th style="width: 20%; text-align: left">EMPLOYEE ID</th>
			<th style="width: 30%; text-align: left"> : {{ $user->nik }}</th>
			<th style="width: 25%; text-align: left">Status</th>
			<th style="width: 25%; text-align: left"> : {{ $user->organisasi_status }}</th>
		</tr>
		<tr>
			<th style="width: 20%; text-align: left">Name</th>
			<th style="width: 30%; text-align: left"> : {{ $user->name }}</th>
			<th style="width: 25%; text-align: left">NPWP</th>
			<th style="width: 25%; text-align: left"> : {{ $user->npwp_number }}</th>
		</tr>
		<tr>
			<th style="width: 20%; text-align: left">Position Title</th>
			<th style="width: 30%; text-align: left"> : {{ empore_jabatan($user->id) }}</th>
			<th style="width: 25%; text-align: left">BPJS Karyawan Number</th>
			<th style="width: 25%; text-align: left"> : {{ $user->bpjs_number }}</th>
		</tr>
	</table>
	<br />
