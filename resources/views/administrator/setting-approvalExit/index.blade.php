                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.setting-approvalExit.indexItem', $item->id) }}"> <button class="btn btn-info btn-xs"><i class="fa fa-arrow-right"></i>Detail</button></a>
                                            @if(isset($item->itemExit))
                                                <a onclick="detail_setting_approval_exit_custom({{ $item->id }})">
