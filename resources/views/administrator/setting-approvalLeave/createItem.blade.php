            ...
            <form class="form-horizontal" id="form-settingApproval" enctype="multipart/form-data" action="{{ route('administrator.setting-approvalLeave.storeItem') }}" method="POST" autocomplete="off">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="{{ route('administrator.setting-approvalLeave.indexItem',$data->id ) }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
