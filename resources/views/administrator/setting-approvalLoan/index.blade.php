        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">SETTING APPROVAL LOAN</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.setting-approvalLoan.indexItem', $item->id) }}"> <button class="btn btn-info btn-xs"><i class="fa fa-arrow-right"></i>Detail</button></a>
                                            @if(isset($item->itemLoan))
                                                <a onclick="detail_setting_approval_loan_custom({{ $item->id }})">
