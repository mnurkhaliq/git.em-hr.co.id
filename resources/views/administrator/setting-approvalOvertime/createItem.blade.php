...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.setting-approvalOvertime.storeItem') }}" method="POST">

                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Add Approval Overtime</h3>
                        <hr />
                        @if (count($errors) > 0)
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="{{ route('administrator.setting-approvalOvertime.indexItem',$data->id ) }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
