        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">SETTING APPROVAL PAYMENT REQUEST</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    ...
                                    <tr> 
                                        ...
                                        <td>@if(isset($item->itemPaymentRequest))
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.setting-approvalPaymentRequest.indexItem', $item->id) }}"> <button class="btn btn-info btn-xs"><i class="fa fa-arrow-right"></i>Detail</button></a>
                                            @if(isset($item->itemPaymentRequest))
                                                <a onclick="detail_setting_approval_paymentRequest_custom({{ $item->id }})">
