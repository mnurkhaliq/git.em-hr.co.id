...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="col-md-6 p-l-0">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" name="setting[mail_signature]" style="height: 120px;" id="ckeditor">{{ get_setting('mail_signature') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form class="form-horizontal" method="POST" action="{{ route('administrator.setting.email-test-send') }}">
                {{ csrf_field() }}
