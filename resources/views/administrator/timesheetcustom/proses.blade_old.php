                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" disabled class="form-control" value="{{ isset($data->user->structure->position) ? $data->user->structure->position->name:''}}{{ isset($data->user->structure->division) ? '-'. $data->user->structure->division->name:'' }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                <tbody class="table-content-lembur">
                                    ...
                                    <tr class="approval-note">
                                        ...
                                        <td colspan="7">
                                            <input type="text" name="transactions[{{ $no }}][note][{{ $val->historyApprovalTimesheet->setting_approval_level_id }}]" disabled class="form-control" value="{{ $val->note }}" />
                                        </td>
                                    </tr>
                                    @endif
                                    @endforeach
