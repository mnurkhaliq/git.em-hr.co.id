...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('administrator.title.store') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input id="titleName" type="text" name="name" class="form-control form-control-line nameCan" value="{{ old('name')}}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input id="titleCode" type="text" name="code" class="form-control form-control-line codeCan" value="{{ old('code')}}">
                                </div>
