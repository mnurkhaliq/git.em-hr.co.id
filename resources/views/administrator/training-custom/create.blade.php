...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" onsubmit="return confirm('Submit Business Trip / Training ?');" enctype="multipart/form-data" action="{{ route('administrator.training-custom.store') }}" method="POST" autocomplete="off">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="kegiatan">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <a href="{{ route('administrator.training-custom.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
