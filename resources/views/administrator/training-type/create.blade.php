                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="name" class="form-control form-control-line" value="{{ old('name')}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Description</label>
                            <div class="col-md-6">
                                <input type="text" name="description" class="form-control form-control-line" value="{{ old('description')}}" required>
                            </div>
                        </div>
