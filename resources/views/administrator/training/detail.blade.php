                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12" style="border: 1px solid #eee; padding: 15px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" required name="tanggal_penyelesaian" value="{{ date('Y-m-d', strtotime( $data->tanggal_pengajuan .' +'.(get_setting('settlement_duration') ?: 10).' day')) }}" readonly="true" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="pesawat">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <label style="font-weight: normal;">
                                                <input type="radio" {{ $data->tipe_perjalanan == 'Sekali Jalan' ? 'checked' : '' }} name="tipe_perjalanan" value="Sekali Jalan"> One Way
                                            </label> &nbsp;&nbsp;
                                            <label style="font-weight: normal;">
                                                <input type="radio" {{ $data->tipe_perjalanan == 'Sekali Jalan' ? 'checked' : '' }} name="tipe_perjalanan" value="Pulang Pergi"> Round Trip
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
