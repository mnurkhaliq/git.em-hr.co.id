                                        ...
                                        <td>
                                            @if($item->status == 2)
                                                @if($item->status_actual_bill >= 2)
                                                    <a href="{{ route('administrator.training.biaya', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5">Detail Actual Bill <i class="fa fa-arrow-right"></i></button></a>
                                                @endif
                                            @endif

                                            @if($item->status == 1)
                                                @if(empty($item->approved_hrd) and $item->is_approved_atasan == 1)
                                                    <a href="{{ route('administrator.training.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5">proses <i class="fa fa-arrow-right"></i></button></a>
                                                @endif
                                                @if($item->approved_hrd == 1)
                                                    <a href="{{ route('administrator.training.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-search-plus"></i> detail</button></a>
                                                @endif
                                            @else
                                                <a href="{{ route('administrator.training.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-search-plus"></i> detail</button></a>
                                            @endif
