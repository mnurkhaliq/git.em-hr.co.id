	...
	<table>
		<thead>
			<tr>
				...
				<td style="border: 1px solid #000000; background:#7f7f7f;color: #ffffff;" rowspan="2"><strong>Branch Clock In</strong></td>
				<td style="border: 1px solid #000000; background:#7f7f7f;color: #ffffff;" rowspan="2"><strong>Location Clock In</strong></td>
				<td style="border: 1px solid #000000; background:#7f7f7f;color: #ffffff;" rowspan="2"><strong>Note/Justification Clock In</strong></td>
				<td style="border: 1px solid #000000; background:#7f7f7f;color: #ffffff;" rowspan="2"><strong>Branch Clock Out</strong></td>
				<td style="border: 1px solid #000000; background:#7f7f7f;color: #ffffff;" rowspan="2"><strong>Location Clock Out</strong></td>
				<td style="border: 1px solid #000000; background:#7f7f7f;color: #ffffff;" rowspan="2"><strong>Note/Justification Clock Out</strong></td>
			</tr>
			<tr>
		...
		<tbody>
			...
			<tr>
				...
				<td style="border: 1px solid #000000;">{{$item->cabangIn?$item->cabangIn->name:""}}</td>
				<td style="border: 1px solid #000000;">{{$item->location_name_in}}</td>
				<td style="border: 1px solid #000000;">{{$item->justification_in}}</td>
				<td style="border: 1px solid #000000;">{{$item->cabangOut?$item->cabangOut->name:""}}</td>
				<td style="border: 1px solid #000000;">{{$item->location_name_out}}</td>
				<td style="border: 1px solid #000000;">{{$item->justification_out}}</td>
			</tr>
			@endforeach
		</tbody>
	</table>
