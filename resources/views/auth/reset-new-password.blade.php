...
<section id="wrapper" class="new-login-register">
      ...
      <div class="new-login-box">
          <div class="white-box">
              ...
              <small>Insert new password to reset your password</small>
              @if (count($errors) > 0)
              ...
              @endif
            <form class="form-horizontal" method="POST" id="loginform" action="{{ route('reset-password-store') }}">

              {{ csrf_field() }}
                <input type="hidden" name="company" value="{{$company}}">
                <input type="hidden" name="token" value="{{$data->password_reset_token}}">
