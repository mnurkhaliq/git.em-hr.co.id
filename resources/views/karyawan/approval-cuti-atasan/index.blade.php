                            ...
                            @foreach($data as $no => $item)
                              @if(isset($item->karyawan->name))
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('karyawan.approval.cuti-atasan.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-search-plus"></i> Detail</button></a>
                                        @if($item->is_approved_atasan ===NULL and $item->status < 4)
                                            <a href="{{ route('karyawan.approval.cuti-atasan.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-search-plus"></i> Process</button></a>
                                        @endif
