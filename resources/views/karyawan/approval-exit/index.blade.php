                                ...
                                @foreach($data as $no => $item)
                                  @if(isset($item->user->nik))
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('karyawan.approval.exit.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-arrow-right"></i> {{ $item->approve_direktur === NULL ? 'proses' : 'detail' }}</button></a>
                                        </td>
                                    </tr>
                                  @endif
                                @endforeach
