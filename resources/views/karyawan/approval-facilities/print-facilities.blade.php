...
<body>
	...
	<p><strong>Dear {{$approval->userApproved->name}},</strong></p>
	<br/>
    <br/>
	...
	<table style="width: 100%;" class="border">
		...
		<tr>
			...
			<td style="border-bottom: 1px solid black;">{!! $tracking->asset->spesifikasi !!}</td>
	...
	<table  style="width: 100%;">
		...
		<tr>
			...
			<th style="text-align: center;"><b><h3>APPROVED</h3></b></th>
		</tr>
		<tr>
			<th style="text-align: center;">{{$tracking->user->name }}</th>
			<th style="text-align: center;">{{$approval->userApproved->name}}</th>
		</tr>
	</table>
</body>
</html>
