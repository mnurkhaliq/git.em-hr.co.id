                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->is_approved_atasan == 1 and $item->approve_direktur === NULL and $item->status < 3)
                                                <a href="{{ route('karyawan.approval.medical.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5">proses <i class="fa fa-arrow-right"></i></button></a>
                                            @else
                                                    <a href="{{ route('karyawan.approval.medical.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5">detail <i class="fa fa-arrow-right"></i></button></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
