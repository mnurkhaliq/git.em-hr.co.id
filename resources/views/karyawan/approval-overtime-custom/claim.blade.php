                        ...
                        <div class="table-responsive">
                                ...
                                <tbody class="table-content-lembur">
                                    ...
                                    <tr>
                                        ...
                                        @if($item->awal_approved != null)
                                        <td><input type="text" name="meal_allowance[]" class="money form-control" {{$readonly}} value="{{ $item->meal_allowance }}" /></td>
                                        @endif
                                        @if($item->awal_approved == null)
                                        <td><input type="text" name="meal_allowance[]" class="money form-control" value="{{ $item->meal_allowance }}" /></td>
                                        @endif
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            date = new Date(date);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        @else
                        overtime_calculate = parseInt(total_hours) + total_minutes;
                        @endif
                    el.parent().parent().find('.overtime_calculate').val(Math.round(overtime_calculate * 10) / 10); 
                    }
                });
