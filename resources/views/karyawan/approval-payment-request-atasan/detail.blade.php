...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-payment-request" enctype="multipart/form-data" action="{{ route('karyawan.approval.payment-request-atasan.proses') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
