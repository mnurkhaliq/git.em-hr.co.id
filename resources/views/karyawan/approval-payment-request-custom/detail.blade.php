...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-payment-request" enctype="multipart/form-data" action="{{ route('karyawan.approval.payment-request-custom.proses') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        {{ csrf_field() }}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->nominal_approved != NULL)
                                                <input type="text" name="nominal_approve[{{ $item->id }}]" max="{{$sisa_plafond}}" onchange="cek_amount_approve(this)" {{$history->is_approved ? 'readonly="true"' : '' }} class="form-control nominal_approve price_format" value="{{ $item->nominal_approved }}" placeholder="Nominal Approve"/>
                                            @endif
                                            @if($item->nominal_approved == NULL)
                                                <input type="text" name="nominal_approve[{{ $item->id }}]" max="{{$sisa_plafond}}" onchange="cek_amount_approve(this)" {{$history->is_approved ? 'readonly="true"' : '' }} class="form-control nominal_approve price_format" value="{{ $item->amount }}" placeholder="Nominal Approve"/>
                                            @endif
                                        </td>
                                        <td>
