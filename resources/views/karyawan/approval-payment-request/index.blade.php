...
-->
                                        ...
                                        <td>
                                            @if($item->approve_direktur === NULL and $item->status < 3)
                                                <a href="{{ route('karyawan.approval.payment_request.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5">process <i class="fa fa-arrow-right"></i></button></a>
                                            @else
                                                <a href="{{ route('karyawan.approval.payment_request.detail', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5">detail <i class="fa fa-search-plus"></i></button></a>
                                            @endif
