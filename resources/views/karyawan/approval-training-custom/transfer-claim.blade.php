...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-actual-bill" enctype="multipart/form-data" action="{{ route('karyawan.approval.training-custom.prosesTransferClaim', $data->id) }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                            ...
                            <table class="table data_table_no_pagging display nowrap" cellspacing="0" width="100%" >
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2" style="width: 4%">Receipt</th>
                                    </tr>
                                    <tr>
                                        <th>Claimed</th>
                                        <th>Approved</th>
                                        ...
                                        <tr>
                                             ...
                                             <td>
                                                @if($item2->morning_approved != null)
                                                 <input type="text" name="morning_approved[]"  class="form-control price_format morning_approved" value="{{ format_idr($item2->morning_approved) }}" {{$readonly}}>
                                                @endif
                                                 @if($item2->morning_approved == null)
                                                <input type="text" name="morning_approved[]" class="form-control price_format morning_approved" value="{{ format_idr($item2->morning) }}" {{$readonly}}>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if($item2->afternoon_approved != null)
                                                 <input type="text" name="afternoon_approved[]"  class="form-control price_format afternoon_approved" value="{{ format_idr($item2->afternoon_approved) }}" {{$readonly}}>
                                                @endif
                                                 @if($item2->afternoon_approved == null)
                                                <input type="text" name="afternoon_approved[]" class="form-control price_format afternoon_approved" value="{{ format_idr($item2->afternoon) }}" {{$readonly}}>
                                                @endif
                                            </td>
                                            ...
                                            <td class="spacer2">
                                                @if($item2->evening_approved != null)
                                                 <input type="text" name="evening_approved[]"  class="form-control price_format evening_approved" value="{{ format_idr($item2->evening_approved) }}" {{$readonly}}>
                                                @endif
                                                 @if($item2->evening_approved == null)
                                                <input type="text" name="evening_approved[]" class="form-control price_format evening_approved" value="{{ format_idr($item2->evening) }}" {{$readonly}}>
                                                @endif
