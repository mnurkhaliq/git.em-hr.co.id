    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Form Clock In</h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                <ol class="breadcrumb">
                    <li><a href="javascript:void(0)">Dashboard</a></li>
                    <li class="active">Clock In</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" enctype="multipart/form-data" id="form-clock-in" action="{{route('karyawan.clock')}}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Clock In</h3>
                        <br />
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group">
                            <label>Type</label>
                            <div class="col-md-12">
                                <input type="checkbox" name="status" id="out_of_office" value="out_of_office">Out of Office
                                <input type="checkbox"  name="shift_status" id="other_shift" value="other_shift"> Other Shift
                            </div>
                        </div>
                        ...
                        <a href="{{ route('karyawan.detail.clock-in') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
                        <button  class="btn" style="color: white;  background:#cbe653;"  id="btn_save">Clock In</button>
                        <br style="clear: both;" />
...
<script language="JavaScript">
    ...
    $("#other_shift").change(function(){
        if($("#other_shift").is(':checked')){
            ...
            $.ajax({
                ...
                method : 'get',
                data: {
                    'shift':$(this).val(),'_token' : $("meta[name='csrf-token']").attr('content')
                },
    ...
    function showPosition(position) {
        ...
        //var userLoc = {lat: -7.1642722, lng: 107.892561};
    ...
    $("#btn_save").click(function(){
        ...
        else if(document.getElementById('selfie').value  == ''){
