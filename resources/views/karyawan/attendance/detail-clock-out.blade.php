                ...
                <div class="col-md-12">
                    <div class="panel panel-warning" style="background: #0E9A88;"> 
                        <div class="panel-body" style="background: #0E9A88; border:1px solid #0E9A88;">
                            ...
                            <h4 style="margin-top:0px; color: white; font-weight: 400;" class="text-center">You  already did clock in today </h4>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <h2 style="margin-bottom:0;color:white; font-weight: 500; font-size: 20px;" class="text-center"><a href="{{route('karyawan.clock-out')}}" class="btn" style="color: white;background:#bd332b"> CLOCK OUT </a></h2>
                            </div>
                            <div class="col-md-4">
                                <p style="margin-bottom:0; color:white; font-weight: 400;" class="text-center">Duration</p>
                                <h2 style="margin-top:0; color:white; font-weight: 400;" class="text-center" id="duration"></h2>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function startTime() {
        ...
        now = h + ":" + m + ":" + s;
        clock_in = "{{$absensi['clock_in']}}" + ":" + s
        m = parseInt(m);
        if(parseInt(m) < parseInt(clock_in.substring(3,5))) {
            duration = (h - 1 - clock_in.substring(0,2)) + ":" + parseInt(m + 60 - clock_in.substring(3,5)) + ":" + s;
        }
        else{
            duration = (h - clock_in.substring(0,2)) + ":" + (m - clock_in.substring(3,5)) + ":" + s;
        }
        var utc = new Date().toJSON().slice(0,10)
        if(utc > "{{$absensi['date']}}"){
            duration = (24 + h - clock_in.substring(0,2))   + ":" + (m - clock_in.substring(3,5)) + ":" + s;
            if(m < clock_in.substring(3,5)) {
                duration = (24 + h - 1 - clock_in.substring(0,2)) + ":" + (m + 60 - clock_in.substring(3,5)) + ":" + s;
            }
            else{
                duration = (24 + h - clock_in.substring(0,2)) + ":" + (m - clock_in.substring(3,5)) + ":" + s;
            }
