                    ...
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" readonly="true" class="form-control jabatan" value="{{ isset($data->user->structure->position) ? $data->user->structure->position->name:''}}{{ isset($data->user->structure->division) ? ' - '. $data->user->structure->division->name:''}}{{ isset($data->user->structure->title) ? ' - '. $data->user->structure->title->name:'' }}">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="col-md-6">{{ $data->user->organisasi_status && $data->user->organisasi_status != 'Permanent' ? 'End Contract Date' : 'Resign Date' }}</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                            <a href="{{ route('karyawan.exit-custom.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
                            </div>
                        </div>
