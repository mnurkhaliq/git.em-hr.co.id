                            ...
                            <tbody>
                                @foreach($data as $no => $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->status < 3)
                                            <a href="{{ route('karyawan.leave.edit', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-book"></i> cancel</button></a>
                                            @else
                                            <a href="{{ route('karyawan.leave.edit', $item->id) }}"> <button class="btn btn-info btn-xs m-r-5"><i class="fa fa-search-plus"></i> detail</button></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
