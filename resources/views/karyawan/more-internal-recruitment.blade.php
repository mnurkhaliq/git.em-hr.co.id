...
@section('title', 'Internal Recruitment')
            ...
            <div class="col-lg-6 col-sm-6 col-md-6">
                <div class="panel panel-warning">
                    <div class="panel-heading">
                        <i class="fa fa-user-plus"></i> Internal Recruitment</h2>
                        <form method="GET" action="" style="float: right; width: 40%;margin-top: -9px;">
                            <div class="form-group">
                                <input type="text" name="keyword" class="form-control" style="float:left;width: 80%;margin-right: 5px;height: 28px;" placeholder="Search Here ..." value="{{ isset($_GET['keyword']) ? $_GET['keyword'] : '' }}" >
                    ...
                    <div class="panel-body panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        @foreach($internal_vacancy as $num => $vacancy)
                            <div class="col-md-12 panel" style="padding:0; font-size: small">
                                    <div  class="" id="heading{{$num}}">
                                        <h4 style="margin-top: 0px; margin-bottom: 5px" class="mb-0">
                                            <a data-toggle="collapse" href="#collapse{{$num}}" data-parent="#accordion" aria-expanded="true" aria-controls="collapse{{$num}}" style="cursor: pointer">
                                    ...
                                    <div id="collapse{{$num}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading{{$num}}" data-parent="#accordion" style="padding-top: 10px">
                                        <div class="">
                                            ...
                                            <center>
                                                ...
                                                @else
                                                    <button class="btn btn-sm btn-success" onclick="apply({{$vacancy->recruitment_id}},{{$num}})"><i class="fa fa-envelope"></i> Apply</button>
                                                @endif
                                            </center>
                                        </div>
                                    </div>
                ...
                <form id="form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" id="job_title" class="form-control" value="IT Support - IT" placeholder="" autocomplete="off" disabled/>
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        ...
        function apply(recruitment_id,num) {
            var job_title = $('#heading'+num+' a').html().trim();
