                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                @foreach($news_list_right as $key => $item)
                                    <div class="overlaybg">
                                        @if(!empty($item->image) && file_exists(public_path('storage/news/').$item->image))
                                        <img src="{{ asset('storage/news/'. $item->image) }}">
                                        @elseif(!empty($item->thumbnail) && file_exists(public_path('storage/news/').$item->thumbnail))
                                    ...
                                    <div class="news-content"><span class="label label-danger label-rounded">News</span>
                                        ...
                                        <a href="{{ route('karyawan.news.readmore', $item->id) }}">Read More</a>
                                    </div>
                                    @break
                                @endforeach
                            </div>
                        ...
                        <div class="white-box" style="padding: 7px 4px 7px 8px;min-height: 99px;">
                            <div class="col-md-4" style="padding:0;">
                                ...
                                <a href="{{ route('karyawan.news.readmore', $item->id) }}">
                                    <img src="{{ asset('storage/news/'. $item->thumbnail) }}" style="width: 100%; height:80px; margin-top: 7px;" />
                                </a>
                                @endif
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-4 col-xs-12">
                            <div class="white-box" style="padding: 7px 4px 7px 8px;">
                                <div class="col-md-4" style="padding:0;">
                                    @if(!empty($item->thumbnail) && file_exists(public_path('storage/news/').$item->thumbnail))
                                    <a href="{{ route('karyawan.news.readmore', $item->id) }}">
                                        <img src="{{ asset('storage/news/'. $item->thumbnail) }}" style="width: 100%; height:80px; margin-top: 2px;" />
                                    </a>
                                    @endif
                                </div>
                                <div class="col-md-8" style="padding-right:0;">
