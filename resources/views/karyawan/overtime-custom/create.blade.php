...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <form class="form-horizontal" autocomplete="off" enctype="multipart/form-data" action="{{ route('karyawan.overtime-custom.store') }}" method="POST">
                <div class="col-md-12 p-l-0 p-r-0">
                    <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered manage-u-table">
                                    ...
                                    <tbody class="table-content-lembur">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td><input type="text" name="tanggal[]" class="form-control scopeDatePicker date_overtime input"></td>
                        ...
                        <div class="clearfix"></div>
                        <br />
                        <a href="{{ route('karyawan.overtime-custom.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
...
<script type="text/javascript">
    ...
    $("#add").click(function(){
        ...
        var html = '<tr>';
            html += '<td>'+ (no+1) +'</td>';
            html += '<td><input type="text" name="tanggal[]" class="form-control scopeDatePicker date_overtime input"></td>';
