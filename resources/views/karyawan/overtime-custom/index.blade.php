    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <a href="{{ route('karyawan.overtime-custom.create') }}" class="btn btn-success btn-sm pull-right m-l-20 waves-effect waves-light"> <i class="fa fa-plus"></i> ADD OVERTIME</a>
            </div>
        </div>
        <!-- .row -->
        <div class="row">
