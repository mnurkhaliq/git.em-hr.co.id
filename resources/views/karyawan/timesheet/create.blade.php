                ...
                <div class="col-md-12">
                    <div class="white-box">
                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                <tbody class="table-content-timesheet">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="activity_name-{{ $no }}" name="transactions[{{ $no }}][timesheet_activity_name]" {{ !$item['timesheet_activity_id'] && $item['timesheet_category_id'] ? '' : 'readonly' }} class="form-control activity_name" value="{{ $item['timesheet_activity_name'] }}"></td>
                        ...
                        <div class="form-group">                            
                            ...
                            <a href="{{ route('karyawan.timesheet.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Cancel</a>
            ...
            $.ajax({
                ...
                success: function(response){
                    $.each(response.week, function(i, data){
                        $('#week').append('<option value="'+data+'">Week '+data+' ('+response.date[i]+')</option>');
                    });
