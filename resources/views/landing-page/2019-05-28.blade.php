...
<body>
	<div>
		<a onclick="openModal()" class="btn btn-info float-right btn_login">Login</a>
		<div class="bg-2" >
		  ...
		  <div class="container container_bottom" style="margin-top: 9%;" id="form_register">
				...
				<form id="form">
					<div class="modal-body" id="modal-add-body">
						<div class="form-group col-md-12">
							...
							<div>
								<input type="text" id="code" name="code" class="form-control" placeholder="Enter Company Code"  autocomplete="off">
							</div>
							<label id="register">Want to register your company? <a onclick="scrollToRegister()" onmouseover="" style="color:deepskyblue;cursor: pointer;" >Click here</a></label>
						</div>
					</div>
