                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0)">
                            ...
                            <b style="color:black;" class="hidden-xs"></b><span class="caret"></span> </a>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav">
                ...
                <ul class="nav" id="side-menu">
                    <li><a href="{{ route('administrator.dashboard') }}"><i class="mdi mdi-chart-bar fa-fw" data-icon="v"></i> Service/modul2 </a></li>
                    <li class="devider"></li>
                </ul>
            </div>
        </div>
