...
<body class="fix-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            ...
                            <li>
                                <a href="{{ route('administrator.switch-to-employee') }}"> <i class="fa fa-key"></i> Switch to Employee</a>
                            </li>
    ...
    function status_approval_exit(id)
        ...
        function detail_approval_timesheet_custom(id)
        {
             $.ajax({
                type: 'POST',
        ...
        function detail_approval_loan_custom(id)
        {
             $.ajax({
                type: 'POST',
    ...
    function detail_setting_approval_recruitment_custom(id)
    {
        $.ajax({
            type: 'POST',
            url: '{{ route('ajax.get-detail-setting-approval-recruitment-item') }}',
            data: {'foreign_id' : id ,'_token' : $("meta[name='csrf-token']").attr('content')},
            dataType: 'json',
            success: function (data) {
                var el = "";
        ...
        function detail_setting_approval_cashAdvance_custom(id)
        {
             $.ajax({
                type: 'POST',
                url: '{{ route('ajax.get-detail-setting-approval-cashAdvance-item') }}',
                data: {'foreign_id' : id ,'_token' : $("meta[name='csrf-token']").attr('content')},
                dataType: 'json',
                success: function (data) {
                    var el = "";
        ...
        function detail_setting_approval_timesheet_custom(id)
        {
             $.ajax({
                type: 'POST',
                url: '{{ route('ajax.get-detail-setting-approval-timesheet-item') }}',
                data: {'foreign_id' : id ,'_token' : $("meta[name='csrf-token']").attr('content')},
                dataType: 'json',
                success: function (data) {
                    var el = "";
        ...
        function detail_setting_approval_loan_custom(id)
        {
             $.ajax({
                type: 'POST',
                url: '{{ route('ajax.get-detail-setting-approval-loan-item') }}',
                data: {'foreign_id' : id ,'_token' : $("meta[name='csrf-token']").attr('content')},
                dataType: 'json',
                success: function (data) {
                    var el = "";
    ...
    <script>
        setTimeout(function() {
            if(!$('#menu_approval').hasClass("active")){
                $('#menu_approval').css("background","rgba(1,1,1,0.2)");
            }
            if(!$('#menu_form').hasClass("active")){
                $('#menu_form').css("background","rgba(1,1,1,0.2)");
            }
        },100);
