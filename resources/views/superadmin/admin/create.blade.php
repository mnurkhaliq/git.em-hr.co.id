                    ...
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                <input type="text" name="nik" value="{{ old('nik') }}"  class="form-control nik"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Email</label>
                                <div class="col-md-10">
                                <input type="email" class="form-control email" name="email" value="{{ old('email') }}"  > </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                <input type="number" name="mobile_1" class="form-control mobile_1" value="{{ old('mobile_1') }}" > </div>
                            </div>
                            <div class="form-group">
