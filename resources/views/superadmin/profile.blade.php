                          ...
                          <form method="POST" action="{{ route('superadmin.update-profile') }}">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <th width="300"><input type="text" name="nik" class="form-control" value="{{ Auth::user()->nik }}" disabled/></th>
                                </tr>
                                <tr>
                                    <th>Email</th>
...
@section('footer-script')
    ...
    <script type="text/javascript">
        ...
        $("#submit_password").click(function(){
            ...
            if(password == "" || confirm == "")
            {
                bootbox.alert('Password or Confirmation Password must be filled in !');
                return false;
            }

            if(password != confirm)
            {
                bootbox.alert('Password is not the same');
            }
            else
            {
                 $.ajax({
