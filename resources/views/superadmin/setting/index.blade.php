...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <form class="form-horizontal" id="form-setting" name="form_setting" enctype="multipart/form-data" action="{{ route('superadmin.setting.save') }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="col-md-4 p-r-0">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input data-jscolor="{}" type="text" class="form-control table_color" style="float: left;" name="setting[table_color]" value="{{ empty(get_setting('table_color')) ? '#797979' : get_setting('table_color') }}">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="text-right">
                            <a href="{{ route('superadmin.setting.rollback') }}" type="button" class="btn text-right" style="background-color: #0E9A88; color:white" data-toggle="tooltip" data-placement="bottom" title="this button to return the display to the default view"><i class="fa fa-back"></i> Set as Default</a>
                        </div>
                    </div>
                </div>
            </form>                   
