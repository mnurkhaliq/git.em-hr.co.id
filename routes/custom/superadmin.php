...
Route::group(['prefix' => 'superadmin', 'namespace'=>'SuperAdmin', 'middleware' => ['auth', 'access:3']], function(){
	...
	Route::post('admin/changeStatus', 'AdminController@changeStatus')->name('superadmin.admin.changeStatus');
	Route::post('admin/changeEnableStatus', 'AdminController@changeEnableStatus')->name('superadmin.admin.changeEnableStatus');
	...
	Route::get('setting/rollback','SettingController@rollback')->name('superadmin.setting.rollback');
